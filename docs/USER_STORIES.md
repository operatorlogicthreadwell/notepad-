...
| Run a Plus edition with PDF annotation and Apple Notes but no AI (Decide hidden and inert) | `plus` (tests/browser/test_plus.js), `backend` |
...
| Build all three .app bundles with one `./build_app.sh` run | **manual-macOS** |
